...
export async function GET(request: Request) {
  try {
    ...
    // TODO: Add companyId field to CompanyProductCapacity schema and filter by it
    ...
    console.log(`[API GET /api/company/products/capacity/list] Returning ${products.length} products for companyId: ${companyId}`)
