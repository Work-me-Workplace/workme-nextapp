    ...
    try {
      ...
      if (workMe) {
        ...
        setFormData(prev => ({
          ...
          profileImage: workMe.photoUrl || firebaseUser?.photoURL || prev.profileImage || '', // Use photoUrl from API (Firebase)
        }))
      } else {
