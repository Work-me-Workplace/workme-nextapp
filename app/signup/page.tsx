        ...
        {!showEmailForm ? (
          <>
            <button
              ...
              className="w-full bg-white text-blue-700 py-4 px-6 rounded-xl font-semibold hover:bg-blue-50 transition shadow-lg disabled:opacity-50 flex items-center justify-center gap-3"
            >
              {isSigningUp ? (
                <>
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={isSigningUp}
                className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl hover:shadow-lg transition-all hover:scale-105 disabled:opacity-50"
              >
